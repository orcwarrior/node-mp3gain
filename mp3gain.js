...
Module['preRun'] = function () {
  ...
  if (ENVIRONMENT_IS_NODE) {
    ...
    return console.error('This tool is only cool with running it in node env!');
  }
};
...
function preprocessArgs(args) {
  ...
  function pathToVirtualMountedPath(orgPath, root) {
    return orgPath.replace('./', '/cwd/').replace(root, '/root/')
  }
}
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mp3gain.wast';
  var wasmBinaryFile = 'mp3gain.wasm';
  var asmjsCodeFile = 'mp3gain.temp.asm.js';
